...
logistic_model = LogisticRegression(n_iter=70000, lr=3e-3, batch_size=32)
...
mlp_model = MultiLayerPerceptron(layer_sizes=[X_train.shape[1],47,101,32,2], n_iter=12000, lr=9e-6, batch_size=32)
...
plot_tree(decision_tree_model, feature_names=['Type','Air temperature [K]','Process temperature [K]','Rotational speed [rpm]','Torque [Nm]','Tool wear [min]'], class_names=True, filled=True)
