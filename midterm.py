...
# linear_model = LinearRegression(n_iter=300000, lr=5e-6, batch_size=64)
...
# perceptron_model = Perceptron(n_iter=10000, lr=2e-4, batch_size=64)
...
# mlp = MLPClassifier(hidden_layer_sizes=(12,47,101,11), activation='relu', solver='adam', max_iter=10000, random_state=42)
# mlp.fit(X_train, Y_train)
# evaluate_model(mlp, X_test, Y_test)
# plot_confusion_results(mlp, X_test, Y_test)
